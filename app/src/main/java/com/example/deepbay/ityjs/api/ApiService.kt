package com.example.deepbay.ityjs.api

import com.example.deepbay.ityjs.mvp.model.bean.AuthorInfoBean
...
interface ApiService{
    ...
    fun getRelateData(@Query("id")id:Long):Observable<HomeBean.Issue>
    /**
     * 获取分类
     */
    @GET("v4/categories")
